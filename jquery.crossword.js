(function ($) {
    $.fn.crossword = function (entryData) {
        ...
        var tbl = ['<center><table id="puzzle"'],
            puzzEl = this,
            clues = $('#puzzle-clues'),
            clueLiEls,
            coords,
            ...
            init: function () {
                ...
                puzzEl.delegate('input', 'keyup', function (e) {
                    ...
                    if (e.keyCode === 9) {
                        ...
                        // Prediksi jawaban
                        var currVal = $('.position-' + activePosition + ' input')
                            .map(function () {
                        ...
                        var answer = puzz.data[activePosition].answer.toLowerCase();
                        if (answer.startsWith(currVal)) {
                            console.log("Prediksi: Jawaban sementara cocok dengan jawaban yang benar.");
                        } else {
                            console.log("Prediksi: Jawaban sementara TIDAK cocok dengan jawaban yang benar.");
                        }
            ...
            buildEntries: function () {
                ...
                for (var x = 1, p = entryCount; x <= p; ++x) {
                    ...
                    for (var i = 0; i < entries[x - 1].length; ++i) {
                        ...
                        if ($(light).empty()) {
                            $(light).attr('id', 'posx-' + puzz.data[x - 1].position);
                            $(light)
            ...
            */
            ...
            checkAnswer: function (e) {
                ...
                if (valToCheck === currVal) {
                    // Menambah poin ketika jawaban benar
                    points += 10; // Misalnya setiap jawaban benar mendapatkan 10 poin
                    console.log("Poin: " + points);

                    // Tandai jawaban sebagai selesai
                    $('.active').addClass('done').removeClass('active');
                    $('.clues-active').addClass('clue-done');
                    solved.push(valToCheck);
                    solvedToggle = true;
                    total_solved = total_solved + 1;
                    puzz_check[puzz.data[activePosition].position - 1] = true;

                    // Cek jika semua jawaban sudah benar
                    ...
                    if (complete_flag) {
                        swal("Crossword Puzzle", "Game Complete\nTotal Poin: " + points, "success");
                    }
                    return;
                } else {
